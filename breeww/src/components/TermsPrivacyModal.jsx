...
const TermsPrivacyModal = ({ isOpen, onClose, onAccept }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 animate-fadeIn">
      <div
        className="w-full max-w-2xl max-h-[90vh] bg-[#11172f] border border-casino-gold/30 rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-modalPop text-white"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Modal Header */}
        <div className="px-6 py-4 bg-gradient-to-r from-[#1a234a] via-[#151c3d] to-[#11172f] border-b border-white/10 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-2xl bg-casino-gold/20 text-casino-gold border border-casino-gold/40 flex items-center justify-center font-black">
              <Scale size={18} />
            </div>
            <div>
              <h2 className="text-base sm:text-lg font-black tracking-tight text-white flex items-center gap-1.5">
                <span className="text-casino-gold">Breeww</span> Legal & Compliance
              </h2>
        ...
        {/* Tab Selector */}
        <div className="flex bg-black/30 border-b border-white/5 px-6 pt-3 gap-2 shrink-0">
          <button
            type="button"
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6 text-xs text-white/80 leading-relaxed font-normal">
          {activeTab === 'terms' ? (
            <>
              {/* Top Highlights */}
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
                ...
                <div className="p-3 rounded-2xl bg-white/5 border border-white/5 flex items-center gap-2">
                  <Award size={16} className="text-casino-gold" />
                  <span className="text-[11px] font-bold text-white/70">Provably Fair SHA-256</span>
                </div>
                <div className="p-3 rounded-2xl bg-white/5 border border-white/5 col-span-2 sm:col-span-1 flex items-center gap-2">
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-casino-gold flex items-center gap-1.5">
              ...
              <section className="space-y-2 p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/20">
            ...
            <>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-casino-gold">
              ...
              {/* Section 4: Security & Cookie Policy */}
              <section className="space-y-2">
                <h3 className="text-sm font-black text-casino-gold">
                  4. Storage & Session Cookies
                </h3>
                <p>
                  We use secure browser storage to store your encrypted authentication token for session continuity. You may clear your browser cookies and local storage at any time to terminate active sessions.
                </p>
              </section>
            </>
          )}
        ...
        {/* Modal Footer */}
        <div className="px-6 py-4 bg-black/40 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 sm:flex-none px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-white/70 hover:text-white font-bold text-xs transition-colors cursor-pointer"
            >
              Close
            </button>
            <button
              ...
              className="flex-1 sm:flex-none px-5 py-2.5 rounded-xl bg-gradient-to-r from-casino-gold via-amber-400 to-orange-500 text-slate-950 font-black text-xs uppercase tracking-wider hover:brightness-110 active:scale-95 shadow-lg transition-all flex items-center justify-center gap-1.5 cursor-pointer"
            >
