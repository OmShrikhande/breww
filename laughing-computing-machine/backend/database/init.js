...
const STATEMENTS = [
  ...
  `ALTER TABLE users ADD COLUMN IF NOT EXISTS vip_level VARCHAR(20) DEFAULT 'None'`,
  `ALTER TABLE users ADD COLUMN IF NOT EXISTS total_bets INT DEFAULT 0`,
  `ALTER TABLE users ADD COLUMN IF NOT EXISTS total_win DECIMAL(14,2) DEFAULT 0.00`,
  `ALTER TABLE users ADD COLUMN IF NOT EXISTS total_loss DECIMAL(14,2) DEFAULT 0.00`,
